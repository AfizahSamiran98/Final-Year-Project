  ...
  <form action="" method="post" id="frmKemaskini">
       <a href="javascript:history.go(-1)" style="color: red; float:left;"><i class="fas fa-angle-double-left"></i> Kembali</a><br>
            ...
            $tajuk_lwtn=$row['tajuk_lwtn'];?>
                ...
                <td style="font-weight: normal;">: <?php echo $row ["nama_aktv"];?> (RM <?php echo $row ["harga_aktv"];?>)</td>
                </tr>
                <tr>
               ...
               <td><hr color="black" align="center" width="100%"></td>
                ...
                <td style="font-weight: normal;">: <?php echo $row ["status_byrn"];?></td>
                </tr>
                <tr>
                <td>Jumlah Pelawat</td>
               ...
               <td><hr color="black" align="center" width="100%"></td>
                    ...
                    <?php 
                if($row['status_MB'] == 'Belum'){
                $id_lwtn=$row['id_lwtn'];?>
                <a class="registerbutton" href="pmaklumbalas.php?id=<?php echo $row["id_lwtn"];?>">Maklum Balas >></a>
            <?php }else{}  }} ?></center><br>
                </form>
                </div>
                </div>
