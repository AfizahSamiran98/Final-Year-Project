...
<html>
<head>
    <title>kemaskini tempahan lawatan</title>
   ...
   <I><a href="logout.php" style="color: red; float:right;"><i class="fas fa-sign-out-alt"></i> Logout</a></I><br/><br/>
            <div><label><h2>KEMASKINI TEMPAHAN LAWATAN</h2></label></div>
             <hr color="black" align="center" width="100%"><br>
                      <table id="customers">
                <?php
            require('connection.php');
            $sql ="SELECT * FROM lawatan WHERE status_lwtn = 'Dalam Proses' || status_lwtn = 'Ditolak'  ORDER BY id_lwtn ASC";
